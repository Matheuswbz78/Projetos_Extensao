...
<link rel="preload" href="EdoSZ.woff2" as="font" type="font/woff2" crossorigin>
<title id='titulo'>Fluxo de Caixa <?php echo $lc_titulo?></title>
<style>@import url('http://fonts.cdnfonts.com/css/edo-sz');</style>
<style>
...
<table cellpadding="1" cellspacing="10"  width="1300" align="center" style="background-color:#000000">
<div id = "logo">

<tr>
<td colspan="11" style="background-color:#303030;">
<h1 style="color:#FFF; margin:5px">Fluxo de Caixa - <?php echo $lc_titulo?></h1>
</td>
...
@font-face {
  ...
  src: url('ACME.eot')format('embedded-opentype');
}
</style>
<td colspan="2" align="right" style="background-color:#202020;">
...
for ($i=1;$i<=12;$i++){
    ...
    <?php if($mes_hoje==$i){?>    
    color:#811810; font-size:16px; font-weight:bold; background-color:#FFF; padding:5px
    <?php }else{?>
...
<table cellpadding="10" cellspacing="0" width="1300" align="center" >
<tr>
<td colspan="2">
<style>
@font-face {
	font-family: [edosz];
	src: url([D:\XAMPP\htdocs\COPIABARATA\font]);
 } 
</style>
<h2><?php echo mostraMes($mes_hoje)?>/<?php echo $ano_hoje?></h2>
</td>
<td align="right">
<a href="javascript:;" onclick="abreFecha('add_cat')" class="bnt" style="color: #000000"><strong>[+] Adicionar Categoria</strong></a>
<a href="javascript:;" onclick="abreFecha('add_movimento')" class="bnt" style="color: #000000"><strong>[+] Adicionar Movimento</strong></a>
</td>
</tr>
...
<input type="dat    e" name="data" size="11" maxlength="10" value="<?php echo date('d')?>/<?php echo $mes_hoje?>/<?php echo $ano_hoje?>" />
...
?>
    ...
    <fieldset>
        <legend>Entradas e Saídas deste mês</legend>
...
<br />
<br />
<table cellpadding="2" cellspacing="0" width="1200" align="center">
<tr>
<td align="center">
<hr size="1" />
<link href="estilo.css" rel="stylesheet" type="text/css" />
<em>© Copyright. All rights reserved Expert Fintech
<button style="background-color:black"; text-color="White";>
<a href="login.php?sair"> <p style="color:white">SAIR</p></a>
</button>
</em>
</td>
</tr>
